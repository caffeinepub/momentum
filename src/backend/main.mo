...
actor {
  ...
  func seedOnboardingRoutines(user : User) {
    let morningRoutine1 : MorningRoutine = {
      id = 0;
    ...
    let morningRoutine2 : MorningRoutine = {
      id = 1;
      text = "Tap Plan to organize";
      completed = false;
      section = #top;
      order = 2 * START_OFFSET;
      streakCount = 0;
      weight = 1;
      displayMode = 0;
    };
    let morningRoutine3 : MorningRoutine = {
      id = 2;
      text = "Hold items to reorder";
      completed = false;
      section = #top;
      order = 3 * START_OFFSET;
      streakCount = 0;
      weight = 1;
      displayMode = 0;
    };

    let eveningRoutine1 : MorningRoutine = {
      id = 3;
      text = "Press + to add task";
      completed = false;
      section = #bottom;
      order = START_OFFSET;
      streakCount = 0;
    ...
    let eveningRoutine2 : MorningRoutine = {
      id = 4;
      text = "Swipe + up... it's shy";
      completed = false;
      section = #bottom;
      order = 2 * START_OFFSET;
      streakCount = 0;
    ...
    let eveningRoutine3 : MorningRoutine = {
      id = 5;
      text = "Hold + to open Plan";
      completed = false;
      section = #bottom;
      order = 3 * START_OFFSET;
      streakCount = 0;
    ...
    user.routines.add(0, morningRoutine1);
    user.routines.add(1, morningRoutine2);
    user.routines.add(2, morningRoutine3);
    user.routines.add(3, eveningRoutine1);
    user.routines.add(4, eveningRoutine2);
    user.routines.add(5, eveningRoutine3);
  };
  ...
  func getOrCreateUserInternal(caller : Principal) : User {
    switch (users.get(caller)) {
      ...
      case (null) {
        ...
        seedOnboardingRoutines(newUser);
