...
import type { List as _List, UserProfile as _UserProfile, UserRole as _UserRole, UserTier as _UserTier } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAllUserLists(): Promise<Array<List> | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllUserLists();
    ...
    async maybeInitializeAllQuadrants(): Promise<Array<List> | null> {
        if (this.processError) {
            try {
                const result = await this.actor.maybeInitializeAllQuadrants();
                return from_candid_opt_n3(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_UserTier_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _UserTier): UserTier {
    return from_candid_variant_n8(_uploadFile, _downloadFile, value);
}
function from_candid_opt_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [Array<_List>]): Array<List> | null {
...
function from_candid_record_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        name: value.name,
        tier: from_candid_UserTier_n7(_uploadFile, _downloadFile, value.tier)
    };
}
...
function to_candid_UserTier_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: UserTier): _UserTier {
...
function to_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        earningsEnabled: value.earningsEnabled,
        name: value.name,
        tier: to_candid_UserTier_n13(_uploadFile, _downloadFile, value.tier)
    };
}
function to_candid_variant_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: UserTier): {
    gold: null;
} | {
    diamond: null;
} | {
